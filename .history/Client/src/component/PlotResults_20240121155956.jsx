...
function PlotResults() {
  // Define constant paths for the images
  const image_path = '../Client/src/assets/input.png';  // Update with the correct path
  const results_path = '../Client/src/assets/results.png';  // Update with the correct path
