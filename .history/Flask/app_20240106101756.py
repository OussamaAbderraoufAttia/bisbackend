...
def predict_and_return_tif(image_data, save_path):
    ...
    binary_prediction.save(path + ".tif")
    binary_prediction = builder.insert_image(path+'.tif')
    binary_prediction.image_data.save(path + ".png")
...
def predict_image():
    ...
    path = '../Client/src/assets/results'
    saved_image_path = predict_and_return_tif(image_file, save_path)
    tumor_image = cv2.imread(save_path)
    path = '../Client/src/assets/result'
    tumor_image.save(path + ".tif")
    shape = builder.insert_image(path+'.tif')
    shape.image_data.save(path + ".png")
