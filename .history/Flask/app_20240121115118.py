...
def predict_and_return_tif(image_data, save_path):
    ...
    img_results = cv2.imread("../Client/src/assets/results.tif")
    cv2.imwrite("results.jpg", binary_prediction)  # OpenCV only supports JPEG for web formats
    cv2.imwrite("inputs.jpg", image_data)
